...
export async function ShippingMethodFindMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    let data;
    if (shape) {
      assertGuard((extended as any).shippingMethod);
      const caller = res.locals.guardCaller;
      data = await (extended as any).shippingMethod
        .guard(shape, caller)
        .findMany(query);
    } else {
      data = await (extended as any).shippingMethod.findMany(query);
    }
...
export async function ShippingMethodFindFirst(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.findFirst(query);
    }
...
export async function ShippingMethodFindUnique(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.findUnique(query);
    }
...
export async function ShippingMethodFindUniqueOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.findUniqueOrThrow(query);
    }
...
export async function ShippingMethodFindFirstOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.findFirstOrThrow(query);
    }
...
export async function ShippingMethodCount(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.count(query);
    }
...
export async function ShippingMethodAggregate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.aggregate(query);
    }
...
export async function ShippingMethodGroupBy(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.groupBy(query);
    }
...
export async function ShippingMethodCreate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.create(body);
    }
...
export async function ShippingMethodCreateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.createMany(body);
    }
...
export async function ShippingMethodCreateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.createManyAndReturn(body);
    }
...
export async function ShippingMethodUpdate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.update(body);
    }
...
export async function ShippingMethodUpdateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.updateMany(body);
    }
...
export async function ShippingMethodUpdateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.updateManyAndReturn(body);
    }
...
export async function ShippingMethodDelete(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.delete(body);
    }
...
export async function ShippingMethodDeleteMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.deleteMany(body);
    }
...
export async function ShippingMethodUpsert(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingMethod.upsert(body);
    }
...
export async function ShippingMethodFindManyPaginated(
  req: Request,
  res: Response,
  next: NextFunction,
) {
    ...
    if (typeof extended.$transaction === "function") {
      try {
        const txResult = await extended.$transaction(async (tx: any) => {
          const d = shape
            ? await tx.shippingMethod.guard(shape, caller).findMany(query)
            : await tx.shippingMethod.findMany(query);
        ...
        if (
          ...
          items = shape
            ? await (extended as any).shippingMethod
                .guard(shape, caller)
                .findMany(query)
            : await (extended as any).shippingMethod.findMany(query);
          total = await countForPagination(
            (extended as any).shippingMethod,
            query,
            shape,
            caller,
          );

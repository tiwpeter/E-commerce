...
export async function ProductImageFindMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    let data;
    if (shape) {
      assertGuard((extended as any).productImage);
      const caller = res.locals.guardCaller;
      data = await (extended as any).productImage
        .guard(shape, caller)
        .findMany(query);
    } else {
      data = await (extended as any).productImage.findMany(query);
    }
...
export async function ProductImageFindFirst(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.findFirst(query);
    }
...
export async function ProductImageFindUnique(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.findUnique(query);
    }
...
export async function ProductImageFindUniqueOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.findUniqueOrThrow(query);
    }
...
export async function ProductImageFindFirstOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.findFirstOrThrow(query);
    }
...
export async function ProductImageCount(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.count(query);
    }
...
export async function ProductImageAggregate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.aggregate(query);
    }
...
export async function ProductImageGroupBy(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.groupBy(query);
    }
...
export async function ProductImageCreate(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.create(body);
    }
...
export async function ProductImageCreateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.createMany(body);
    }
...
export async function ProductImageCreateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.createManyAndReturn(body);
    }
...
export async function ProductImageUpdate(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.update(body);
    }
...
export async function ProductImageUpdateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.updateMany(body);
    }
...
export async function ProductImageUpdateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.updateManyAndReturn(body);
    }
...
export async function ProductImageDelete(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.delete(body);
    }
...
export async function ProductImageDeleteMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.deleteMany(body);
    }
...
export async function ProductImageUpsert(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productImage.upsert(body);
    }
...
export async function ProductImageFindManyPaginated(
  req: Request,
  res: Response,
  next: NextFunction,
) {
    ...
    if (typeof extended.$transaction === "function") {
      try {
        const txResult = await extended.$transaction(async (tx: any) => {
          const d = shape
            ? await tx.productImage.guard(shape, caller).findMany(query)
            : await tx.productImage.findMany(query);
        ...
        if (
          ...
          items = shape
            ? await (extended as any).productImage
                .guard(shape, caller)
                .findMany(query)
            : await (extended as any).productImage.findMany(query);
          total = await countForPagination(
            (extended as any).productImage,
            query,
            shape,
            caller,
          );

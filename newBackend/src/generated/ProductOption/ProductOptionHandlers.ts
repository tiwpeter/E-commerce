...
export async function ProductOptionFindMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    let data;
    if (shape) {
      assertGuard((extended as any).productOption);
      const caller = res.locals.guardCaller;
      data = await (extended as any).productOption
        .guard(shape, caller)
        .findMany(query);
    } else {
      data = await (extended as any).productOption.findMany(query);
    }
...
export async function ProductOptionFindFirst(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.findFirst(query);
    }
...
export async function ProductOptionFindUnique(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.findUnique(query);
    }
...
export async function ProductOptionFindUniqueOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.findUniqueOrThrow(query);
    }
...
export async function ProductOptionFindFirstOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.findFirstOrThrow(query);
    }
...
export async function ProductOptionCount(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.count(query);
    }
...
export async function ProductOptionAggregate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.aggregate(query);
    }
...
export async function ProductOptionGroupBy(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.groupBy(query);
    }
...
export async function ProductOptionCreate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.create(body);
    }
...
export async function ProductOptionCreateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.createMany(body);
    }
...
export async function ProductOptionCreateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.createManyAndReturn(body);
    }
...
export async function ProductOptionUpdate(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.update(body);
    }
...
export async function ProductOptionUpdateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.updateMany(body);
    }
...
export async function ProductOptionUpdateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.updateManyAndReturn(body);
    }
...
export async function ProductOptionDelete(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.delete(body);
    }
...
export async function ProductOptionDeleteMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.deleteMany(body);
    }
...
export async function ProductOptionUpsert(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productOption.upsert(body);
    }
...
export async function ProductOptionFindManyPaginated(
  req: Request,
  res: Response,
  next: NextFunction,
) {
    ...
    if (typeof extended.$transaction === "function") {
      try {
        const txResult = await extended.$transaction(async (tx: any) => {
          const d = shape
            ? await tx.productOption.guard(shape, caller).findMany(query)
            : await tx.productOption.findMany(query);
        ...
        if (
          ...
          items = shape
            ? await (extended as any).productOption
                .guard(shape, caller)
                .findMany(query)
            : await (extended as any).productOption.findMany(query);
          total = await countForPagination(
            (extended as any).productOption,
            query,
            shape,
            caller,
          );

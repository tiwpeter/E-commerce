...
export async function ProductVariantFindMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    let data;
    if (shape) {
      assertGuard((extended as any).productVariant);
      const caller = res.locals.guardCaller;
      data = await (extended as any).productVariant
        .guard(shape, caller)
        .findMany(query);
    } else {
      data = await (extended as any).productVariant.findMany(query);
    }
...
export async function ProductVariantFindFirst(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.findFirst(query);
    }
...
export async function ProductVariantFindUnique(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.findUnique(query);
    }
...
export async function ProductVariantFindUniqueOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.findUniqueOrThrow(query);
    }
...
export async function ProductVariantFindFirstOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.findFirstOrThrow(query);
    }
...
export async function ProductVariantCount(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.count(query);
    }
...
export async function ProductVariantAggregate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.aggregate(query);
    }
...
export async function ProductVariantGroupBy(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.groupBy(query);
    }
...
export async function ProductVariantCreate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.create(body);
    }
...
export async function ProductVariantCreateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.createMany(body);
    }
...
export async function ProductVariantCreateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.createManyAndReturn(body);
    }
...
export async function ProductVariantUpdate(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.update(body);
    }
...
export async function ProductVariantUpdateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.updateMany(body);
    }
...
export async function ProductVariantUpdateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.updateManyAndReturn(body);
    }
...
export async function ProductVariantDelete(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.delete(body);
    }
...
export async function ProductVariantDeleteMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.deleteMany(body);
    }
...
export async function ProductVariantUpsert(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).productVariant.upsert(body);
    }
...
export async function ProductVariantFindManyPaginated(
  req: Request,
  res: Response,
  next: NextFunction,
) {
    ...
    if (typeof extended.$transaction === "function") {
      try {
        const txResult = await extended.$transaction(async (tx: any) => {
          const d = shape
            ? await tx.productVariant.guard(shape, caller).findMany(query)
            : await tx.productVariant.findMany(query);
        ...
        if (
          ...
          items = shape
            ? await (extended as any).productVariant
                .guard(shape, caller)
                .findMany(query)
            : await (extended as any).productVariant.findMany(query);
          total = await countForPagination(
            (extended as any).productVariant,
            query,
            shape,
            caller,
          );

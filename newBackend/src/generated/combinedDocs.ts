...
import { CategoryDocs } from "./Category/CategoryDocs";
import { ProductDocs } from "./Product/ProductDocs";
import { ProductImageDocs } from "./ProductImage/ProductImageDocs";
import { ProductOptionDocs } from "./ProductOption/ProductOptionDocs";
import { OptionValueDocs } from "./OptionValue/OptionValueDocs";
import { ProductVariantDocs } from "./ProductVariant/ProductVariantDocs";
import { VariantOptionValueDocs } from "./VariantOptionValue/VariantOptionValueDocs";
import { ShippingZoneDocs } from "./ShippingZone/ShippingZoneDocs";
import { ShippingMethodDocs } from "./ShippingMethod/ShippingMethodDocs";
import { ShippingRateDocs } from "./ShippingRate/ShippingRateDocs";
import { CartDocs } from "./Cart/CartDocs";
import { CartItemDocs } from "./CartItem/CartItemDocs";
import { AddressDocs } from "./Address/AddressDocs";
import { OrderDocs } from "./Order/OrderDocs";
import { OrderItemDocs } from "./OrderItem/OrderItemDocs";
import { PaymentDocs } from "./Payment/PaymentDocs";
import { ReviewDocs } from "./Review/ReviewDocs";
...
> = {
  ...
  Product: ProductDocs,
  ProductImage: ProductImageDocs,
  ProductOption: ProductOptionDocs,
  OptionValue: OptionValueDocs,
  ProductVariant: ProductVariantDocs,
  VariantOptionValue: VariantOptionValueDocs,
  ShippingZone: ShippingZoneDocs,
  ShippingMethod: ShippingMethodDocs,
  ShippingRate: ShippingRateDocs,
  Cart: CartDocs,
  CartItem: CartItemDocs,
  Address: AddressDocs,
  Order: OrderDocs,
  OrderItem: OrderItemDocs,
  Payment: PaymentDocs,
  Review: ReviewDocs,
};

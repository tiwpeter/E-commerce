...
export async function OptionValueFindMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    let data;
    if (shape) {
      assertGuard((extended as any).optionValue);
      const caller = res.locals.guardCaller;
      data = await (extended as any).optionValue
        .guard(shape, caller)
        .findMany(query);
    } else {
      data = await (extended as any).optionValue.findMany(query);
    }
...
export async function OptionValueFindFirst(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.findFirst(query);
    }
...
export async function OptionValueFindUnique(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.findUnique(query);
    }
...
export async function OptionValueFindUniqueOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.findUniqueOrThrow(query);
    }
...
export async function OptionValueFindFirstOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.findFirstOrThrow(query);
    }
...
export async function OptionValueCount(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.count(query);
    }
...
export async function OptionValueAggregate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.aggregate(query);
    }
...
export async function OptionValueGroupBy(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.groupBy(query);
    }
...
export async function OptionValueCreate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.create(body);
    }
...
export async function OptionValueCreateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.createMany(body);
    }
...
export async function OptionValueCreateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.createManyAndReturn(body);
    }
...
export async function OptionValueUpdate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.update(body);
    }
...
export async function OptionValueUpdateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.updateMany(body);
    }
...
export async function OptionValueUpdateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.updateManyAndReturn(body);
    }
...
export async function OptionValueDelete(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.delete(body);
    }
...
export async function OptionValueDeleteMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.deleteMany(body);
    }
...
export async function OptionValueUpsert(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).optionValue.upsert(body);
    }
...
export async function OptionValueFindManyPaginated(
  req: Request,
  res: Response,
  next: NextFunction,
) {
    ...
    if (typeof extended.$transaction === "function") {
      try {
        const txResult = await extended.$transaction(async (tx: any) => {
          const d = shape
            ? await tx.optionValue.guard(shape, caller).findMany(query)
            : await tx.optionValue.findMany(query);
        ...
        if (
          ...
          items = shape
            ? await (extended as any).optionValue
                .guard(shape, caller)
                .findMany(query)
            : await (extended as any).optionValue.findMany(query);
          total = await countForPagination(
            (extended as any).optionValue,
            query,
            shape,
            caller,
          );

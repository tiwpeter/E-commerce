...
export async function ShippingZoneFindMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    let data;
    if (shape) {
      assertGuard((extended as any).shippingZone);
      const caller = res.locals.guardCaller;
      data = await (extended as any).shippingZone
        .guard(shape, caller)
        .findMany(query);
    } else {
      data = await (extended as any).shippingZone.findMany(query);
    }
...
export async function ShippingZoneFindFirst(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.findFirst(query);
    }
...
export async function ShippingZoneFindUnique(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.findUnique(query);
    }
...
export async function ShippingZoneFindUniqueOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.findUniqueOrThrow(query);
    }
...
export async function ShippingZoneFindFirstOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.findFirstOrThrow(query);
    }
...
export async function ShippingZoneCount(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.count(query);
    }
...
export async function ShippingZoneAggregate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.aggregate(query);
    }
...
export async function ShippingZoneGroupBy(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.groupBy(query);
    }
...
export async function ShippingZoneCreate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.create(body);
    }
...
export async function ShippingZoneCreateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.createMany(body);
    }
...
export async function ShippingZoneCreateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.createManyAndReturn(body);
    }
...
export async function ShippingZoneUpdate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.update(body);
    }
...
export async function ShippingZoneUpdateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.updateMany(body);
    }
...
export async function ShippingZoneUpdateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.updateManyAndReturn(body);
    }
...
export async function ShippingZoneDelete(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.delete(body);
    }
...
export async function ShippingZoneDeleteMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.deleteMany(body);
    }
...
export async function ShippingZoneUpsert(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingZone.upsert(body);
    }
...
export async function ShippingZoneFindManyPaginated(
  req: Request,
  res: Response,
  next: NextFunction,
) {
    ...
    if (typeof extended.$transaction === "function") {
      try {
        const txResult = await extended.$transaction(async (tx: any) => {
          const d = shape
            ? await tx.shippingZone.guard(shape, caller).findMany(query)
            : await tx.shippingZone.findMany(query);
        ...
        if (
          ...
          items = shape
            ? await (extended as any).shippingZone
                .guard(shape, caller)
                .findMany(query)
            : await (extended as any).shippingZone.findMany(query);
          total = await countForPagination(
            (extended as any).shippingZone,
            query,
            shape,
            caller,
          );

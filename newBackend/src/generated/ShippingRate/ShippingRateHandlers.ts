...
export async function ShippingRateFindMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    let data;
    if (shape) {
      assertGuard((extended as any).shippingRate);
      const caller = res.locals.guardCaller;
      data = await (extended as any).shippingRate
        .guard(shape, caller)
        .findMany(query);
    } else {
      data = await (extended as any).shippingRate.findMany(query);
    }
...
export async function ShippingRateFindFirst(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.findFirst(query);
    }
...
export async function ShippingRateFindUnique(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.findUnique(query);
    }
...
export async function ShippingRateFindUniqueOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.findUniqueOrThrow(query);
    }
...
export async function ShippingRateFindFirstOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.findFirstOrThrow(query);
    }
...
export async function ShippingRateCount(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.count(query);
    }
...
export async function ShippingRateAggregate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.aggregate(query);
    }
...
export async function ShippingRateGroupBy(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.groupBy(query);
    }
...
export async function ShippingRateCreate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.create(body);
    }
...
export async function ShippingRateCreateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.createMany(body);
    }
...
export async function ShippingRateCreateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.createManyAndReturn(body);
    }
...
export async function ShippingRateUpdate(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.update(body);
    }
...
export async function ShippingRateUpdateMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.updateMany(body);
    }
...
export async function ShippingRateUpdateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.updateManyAndReturn(body);
    }
...
export async function ShippingRateDelete(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.delete(body);
    }
...
export async function ShippingRateDeleteMany(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.deleteMany(body);
    }
...
export async function ShippingRateUpsert(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).shippingRate.upsert(body);
    }
...
export async function ShippingRateFindManyPaginated(
  req: Request,
  res: Response,
  next: NextFunction,
) {
    ...
    if (typeof extended.$transaction === "function") {
      try {
        const txResult = await extended.$transaction(async (tx: any) => {
          const d = shape
            ? await tx.shippingRate.guard(shape, caller).findMany(query)
            : await tx.shippingRate.findMany(query);
        ...
        if (
          ...
          items = shape
            ? await (extended as any).shippingRate
                .guard(shape, caller)
                .findMany(query)
            : await (extended as any).shippingRate.findMany(query);
          total = await countForPagination(
            (extended as any).shippingRate,
            query,
            shape,
            caller,
          );

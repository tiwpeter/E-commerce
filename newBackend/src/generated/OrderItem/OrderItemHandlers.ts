...
export async function OrderItemFindMany(
  ...
  try {
    ...
    let data;
    if (shape) {
      assertGuard((extended as any).orderItem);
      const caller = res.locals.guardCaller;
      data = await (extended as any).orderItem
        .guard(shape, caller)
        .findMany(query);
    } else {
      data = await (extended as any).orderItem.findMany(query);
    }
...
export async function OrderItemFindFirst(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.findFirst(query);
    }
...
export async function OrderItemFindUnique(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.findUnique(query);
    }
...
export async function OrderItemFindUniqueOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.findUniqueOrThrow(query);
    }
...
export async function OrderItemFindFirstOrThrow(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.findFirstOrThrow(query);
    }
...
export async function OrderItemCount(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.count(query);
    }
...
export async function OrderItemAggregate(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.aggregate(query);
    }
...
export async function OrderItemGroupBy(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.groupBy(query);
    }
...
export async function OrderItemCreate(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.create(body);
    }
...
export async function OrderItemCreateMany(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.createMany(body);
    }
...
export async function OrderItemCreateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.createManyAndReturn(body);
    }
...
export async function OrderItemUpdate(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.update(body);
    }
...
export async function OrderItemUpdateMany(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.updateMany(body);
    }
...
export async function OrderItemUpdateManyAndReturn(
  req: Request,
  res: Response,
  next: NextFunction,
) {
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.updateManyAndReturn(body);
    }
...
export async function OrderItemDelete(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.delete(body);
    }
...
export async function OrderItemDeleteMany(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.deleteMany(body);
    }
...
export async function OrderItemUpsert(
  ...
  try {
    ...
    if (shape) {
      ...
      data = await (extended as any).orderItem.upsert(body);
    }
...
export async function OrderItemFindManyPaginated(
  req: Request,
  res: Response,
  next: NextFunction,
) {
    ...
    if (typeof extended.$transaction === "function") {
      try {
        const txResult = await extended.$transaction(async (tx: any) => {
          const d = shape
            ? await tx.orderItem.guard(shape, caller).findMany(query)
            : await tx.orderItem.findMany(query);
        ...
        if (
          ...
          items = shape
            ? await (extended as any).orderItem
                .guard(shape, caller)
                .findMany(query)
            : await (extended as any).orderItem.findMany(query);
          total = await countForPagination(
            (extended as any).orderItem,
            query,
            shape,
            caller,
          );
      ...
      items = shape
        ? await (extended as any).orderItem.guard(shape, caller).findMany(query)
        : await (extended as any).orderItem.findMany(query);
      total = await countForPagination(
        (extended as any).orderItem,
        query,
